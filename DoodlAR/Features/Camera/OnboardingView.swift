...
private let stepItems: [OnboardingStep] = [
    OnboardingStep(
        icon: "pencil.line",
        title: "Draw a doodle",
        description: "Make a creature with big shapes and bold lines.",
        tint: Color(red: 1.0, green: 0.76, blue: 0.40)
    ),
    OnboardingStep(
        icon: "camera.aperture",
        title: "Scan your page",
        description: "Point the camera so your whole drawing stays inside the frame.",
        tint: Color(red: 0.48, green: 0.93, blue: 0.85)
    ),
    OnboardingStep(
        icon: "sparkles",
        title: "See it wake up",
        description: "Your creature pops into the room as a playful AR friend.",
        tint: Color(red: 0.60, green: 0.76, blue: 1.0)
    )
]
